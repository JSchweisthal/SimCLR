...
### new
    ...
    #####
        ...
        ###################################
        # !!!!!!!!! currently just averaged value and target, can also be computed componentwise and then be averaged!
        ##################################
        ...
        reg_mix_log = torch.exp((torch.log(sim_x_mixup+(1/args.temperature)) - torch.log(sim_mixup+(1/args.temperature)) ) ** 2)-1 #  logs around sims??? +1 for
